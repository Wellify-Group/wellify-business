-- =====================================================
-- КОПИРУЙТЕ И ВСТАВЬТЕ ЭТОТ КОД В SUPABASE SQL EDITOR
-- Выполните для DEV проекта, затем для PRODUCTION проекта
-- =====================================================

-- 1. Создание таблицы email_verifications
...
-- 2. Создание функции для подтверждения email
